...
public class GameView extends JPanel implements IPhaseEvent {
    ...
    public GameView(ICardControls controls) {
        ...
        this.readyView = new ReadyView(controls);
        this.readyView.setName(READY_PANEL);
        gameContainer.add(READY_PANEL, this.readyView);
    ...
    public void onReceivePhase(Phase phase) {
        ...
        if (phase == Phase.READY) {
            readyView.resetReady(); // Reset ready status when returning to READY phase
