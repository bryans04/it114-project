...
public class ClientUI extends JFrame implements ICardControls, IConnectionEvents, IRoomEvents, IPhaseEvent {
    ...
    public void onReceivePhase(Phase phase) {
        ...
        // Other phases (like IN_PROGRESS) are handled by game views
    }
