...
public enum PayloadType {
       ...
       PLAYER_PICK, // client sending their rock/paper/scissors choice
       GAME_MODE, // session creator setting game mode (RPS-3, RPS-5, etc)
       GAME_OVER, // server announcing game/session winner(s)
       AWAY, // client toggling away status
       SPECTATOR_JOIN, // client requesting to join a room as a spectator
       TIME, // syncs current time of various timers
       POINTS, // syncs points data
       ELIMINATION, // syncs elimination status
}